self.port.on("bookmarkGifs",function(){
...
var bookmarklet = function() {
 ...
 // INSERT_GIF_JS_HERE
  ...
  var playGIF = function(gif) {
    ...
    var doPlay = (function() {
        ...
        var initToolbar = function() {
          ...
          var mousewheelevt=(/Firefox/i.test(navigator.userAgent))? "DOMMouseScroll" : "mousewheel" //FF doesn't recognize mousewheel as of FF3.x
                ...
                { 
                    if( keyDown === "shift" ) {
                        if( e.wheelDelta > 0 ) 
                            ...
                            delayModifier -= 0.05;
                        if( delayModifier < 0.001 ) delayModifier = 0.001;
                    }
                    else {
                        if( e.wheelDelta > 0 ) 
                            doPrevFrame(); 
            ...
            window.addEventListener('keydown', function(e) { if (!e) e = window.event; if (e.ctrlKey) keyDown = "ctrl"; if (e.shiftKey) keyDown = "shift";}, false);
            window.addEventListener('keyup', function(e) { keyDown = null; }, false);
    ...
    div.style.cssText = "position:absolute;top:0;bottom:0;left:0;right:0;margin:auto;width:" + gif.width + "px;height:" + gif.height + "px;";
	
	
    //div.style.cssText = div.style.cssText + document.defaultView.getComputedStyle(gif, "").cssText;
    //div.style.cssText= gif.style.cssText;
